...
public class ShopInfo extends JFrame {
	...
	private void initialize() {
		...
		scrPaneOrderList.setBounds(12, 80, 362, 115);
		...
		tableOrder.getColumnModel().getColumn(0).setPreferredWidth(193);
		tableOrder.getColumnModel().getColumn(1).setPreferredWidth(59);
		tableOrder.getColumnModel().getColumn(2).setPreferredWidth(50);
		tableOrder.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
		tableOrder.setBorder(null);
		scrPaneOrderList.setViewportView(tableOrder);
