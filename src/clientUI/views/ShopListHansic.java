...
public class ShopListHansic extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopListHansic frame = new ShopListHansic();
	...
	private void createEvents() {
		...
		btnGo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {	//이동버튼 클릭
				...
				System.out.println("최종 가계선택"+fname);
				
				ShopInfo.s_info=sls.selectShopSearch(fname);
				System.out.println(ShopInfo.s_info);
				new ShopInfo();
		...
		listFood.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {	//리스트에서 업체명 클릭
				...
				////리스트에서 업체명 클릭
				//////////////////////////////////////////////
				fname=(String)listFood.getSelectedValue();
