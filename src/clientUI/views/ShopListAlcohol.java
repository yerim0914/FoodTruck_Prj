...
public class ShopListAlcohol extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopListAlcohol frame = new ShopListAlcohol();
	...
	private void createEvents() {
		...
		listFood.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {	//리스트에서 업체명 클릭
				System.out.println(listFood.getSelectedValue());
				///////////////////////////////////////
				////리스트에서 업체명 클릭
				//////////////////////////////////////////////
