...
public class ShopListDrink extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopListDrink frame = new ShopListDrink();
