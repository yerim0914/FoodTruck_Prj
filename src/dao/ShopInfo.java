...
import clientUI.test.ClientMenu;
...
public class ShopInfo extends JFrame {
	...
	private void initialize() {
		...
		JTextArea txtrDjag = new JTextArea();
		txtrDjag.setText("djag\r\nasdgasdgasg\r\nsadgasgd\r\n\r\n");
		scrPaneSchedule.setViewportView(txtrDjag);
		...
		//↓ 메뉴 불러오기
		////////////////////////////////////////////////////////////////
		cbOrderMenu.setModel(new DefaultComboBoxModel(new String[] {"메뉴 테스트1", "메뉴 테스트2"}));
		...
		listOrderList.setModel(new AbstractListModel() {
			String[] values = new String[] {"\uCD94\uAC00\uBA54\uB274 \uD14C\uC2A4\uD2B8 1", "\uCD94\uAC00\uBA54\uB274 \uD14C\uC2A4\uD2B8 2", "\uCD94\uAC00\uBA54\uB274 \uD14C\uC2A4\uD2B8 3", "\uCD94\uAC00\uBA54\uB274 \uD14C\uC2A4\uD2B8 4", "\uCD94\uAC00\uBA54\uB274 \uD14C\uC2A4\uD2B8 5", "\uCD94\uAC00\uBA54\uB274 \uD14C\uC2A4\uD2B8 6"};
			public int getSize() {
